...
namespace testerApp
{
    public partial class frmMain : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //msg.Type = "login";
            //msg.Ver = "1.0";
            //msg.Datetime = "2016-10-12 13:50";
            //LoginMessage subMsg = new LoginMessage();
            //subMsg.Name = "yanhai";
            //subMsg.Pwd = "123456";
            //subMsg.Os = "pc";
            //msg.Body = subMsg;
            ...
            msg.Ver = "1.0";
            msg.Datetime = "2016-10-12 13:50";
            GetFoodsMsg subMsg = new GetFoodsMsg();
            subMsg.Type_id = 0;
           subMsg.Foods = new List<Food_Info>();
            Food_Info fi1 = new Food_Info();
            fi1.name = "番茄炒蛋";
            fi1.price = (float)10.0;
            fi1.imgurl = new List<string>();
            fi1.imgurl.Add("www.taobao.com");
            fi1.desc = "AAAAAAAAAAAAAAAA中文你好";
            subMsg.Foods.Add(fi1);
            msg.Body = subMsg;
            string str = msg.Serialize();
